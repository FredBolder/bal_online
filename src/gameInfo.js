    ...
    for (let i = 0; i < gameData.length; i++) {
        for (let j = 0; j < gameData[i].length; j++) {
            ...
            switch (objectNumber) {
                ...
                case 178: {
                    let mover = { x: j, y: i, direction: "right", activeSides: ["top"], mode: "all", inverted: false, counter: 0 };
                ...
                case 255: {
                    let detector = { x: j, y: i, mode: "all", oneTime: false, activeSides: ["top"], target: "group", value: "", display: "default", activated: false, activatedCount: 0, group: 1 };
    ...
    switch (objectNumber) {
        ...
        case 178:
            ...
            if (idx >= 0) {
                ...
                extraInfo = `Direction: ${obj.direction}, Active sides: ${obj.activeSides}, Mode: ${obj.mode}, Inverted: ${obj.inverted}, Counter: ${obj.counter}`;
            }
        ...
        switch (objectNumber) {
            ...
            case 248:
                ...
                if (idx >= 0) {
                    ...
                    extraInfo = `Out of water: ${obj.outOfWater}, Dead: ${obj.isDead}`;
                }
            ...
            case 255:
                ...
                if (idx >= 0) {
                    ...
                    extraInfo = `Mode: ${obj.mode}, One-time: ${obj.oneTime}, Active sides: ${obj.activeSides}, Target: ${obj.target}, Value: ${obj.value}, Display: ${obj.display}, Activated: ${obj.activated}, Activated count: ${obj.activatedCount}, Group: ${obj.group}`;
                }
