...
export function copyCell(backData, gameData, gameInfo, x1, y1, x2, y2) {
    ...
    switch (obj) {
        ...
        case 7:
            ...
            break;
        case 27:
            idx1 = findElementByCoordinates(x1, y1, gameInfo.redFish);
            idx2 = findElementByCoordinates(x2, y2, gameInfo.redFish);
            if ((idx1 >= 0) && (idx2 >= 0)) {
        ...
        case 243:
            ...
            if ((idx1 >= 0) && (idx2 >= 0)) {
                ...
                gameInfo.tropicalFish[idx2].maxDistX = gameInfo.tropicalFish[idx1].maxDistX;
                gameInfo.tropicalFish[idx2].palette = gameInfo.tropicalFish[idx1].palette;
                gameInfo.tropicalFish[idx2].pupilPercentage = gameInfo.tropicalFish[idx1].pupilPercentage;
        ...
        case 255:
            ...
            if ((idx1 >= 0) && (idx2 >= 0)) {
                ...
                gameInfo.detectors[idx2].range = gameInfo.detectors[idx1].range;
                gameInfo.detectors[idx2].sequence = gameInfo.detectors[idx1].sequence;
                gameInfo.detectors[idx2].target = gameInfo.detectors[idx1].target;
                gameInfo.detectors[idx2].text = gameInfo.detectors[idx1].text;
