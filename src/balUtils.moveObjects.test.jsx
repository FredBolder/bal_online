...
describe("balUtils moveObjects", () => {
    ...
    moveObjects(gameInfo01a, { ...defaultGameVars }, "insertRow", 0, 4, 0, 0);
    it("moveObjects A", () => {
    ...
    moveObjects(gameInfo01b, { ...defaultGameVars }, "insertColumn", 3, 0, 0, 0);
    it("moveObjects B", () => {
    ...
    moveObjects(gameInfo01c, { ...defaultGameVars }, "deleteRow", 0, 3, 0, 0);
    it("moveObjects C", () => {
    ...
    moveObjects(gameInfo01d, { ...defaultGameVars }, "deleteRow", 0, 5, 0, 0);
    it("moveObjects D", () => {
    ...
    moveObjects(gameInfo01e, { ...defaultGameVars }, "deleteColumn", 1, 0, 0, 0);
    it("moveObjects E", () => {
    ...
    moveObjects(gameInfo01f, { ...defaultGameVars }, "insertColumn", 7, 0, 0, 0);
    it("moveObjects F", () => {
    ...
    moveObjects(gameInfo01g, { ...defaultGameVars }, "insertRow", 0, 5, 0, 0);
    it("moveObjects G", () => {
    ...
    moveObjects(gameInfo01h, { ...defaultGameVars }, "moveCell", 3, 5, 10, 4);
    it("moveObjects H", () => {
